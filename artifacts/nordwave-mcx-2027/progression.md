...
Gaps found: **53** · dispatched: **5** ·
held by the level gate: **48**.
...
| Held gap | Reason |
|---|---|
| G1_empty_section | subject at L0_named, needs L2_decomposed |
| G1_empty_section | subject at L0_named, needs L2_decomposed |
| G1_empty_section | subject at L0_named, needs L3_decided |
| G1_empty_section | subject at L0_named, needs L3_decided |
| G1_empty_section | subject at L0_named, needs L2_decomposed |

| Question | Subject | Routed to | Blocks |
|---|---|---|---|
| Q-0001 | mobile-core | mobile-core-architect | 5.1.1, 5.1.2, 5.2, 5.3, 8.4 |
| Q-0002 | automation-chain | chief-architect | 8.1.1, 8.2, 8.3, 8.4, 8.5 |
| Q-0003 | delivery-plan | delivery-lead | 10.2, 10.3, 10.4, 10.5 |
| Q-0004 | engagement-scope | chief-architect | 1.2, 2.1 |
| Q-0005 | mcx-services | mcx-service-architect | 2.3, 6.3 |

```mermaid
graph TD
    GATE["Level gate: 48 gaps held"]:::held
    Q0001["Q-0001 → mobile-core"]
    Q0002["Q-0002 → automation-chain"]
    Q0003["Q-0003 → delivery-plan"]
    Q0004["Q-0004 → engagement-scope"]
    Q0005["Q-0005 → mcx-services"]
...
engendered **6 active framing questions** dispatched to architects,
advanced `mcx-services` to `L2_decomposed`, and released
**1** previously held parameter gaps for `mcx-services`.
...
|---|---|---|---|
| engagement-scope | █ · · · · | L0_named | — |
| mcx-services | █ █ █ · · | L2_decomposed | — |
| mobile-core | █ · · · · | L0_named | — |
| transport | █ · · · · | L0_named | — |
| rancher-domain | █ · · · · | L0_named | — |
| observation | █ · · · · | L0_named | — |
| automation-chain | █ · · · · | L0_named | — |
| service-management | █ · · · · | L0_named | — |
| security-posture | █ · · · · | L0_named | — |
| ai-assistance | █ · · · · | L0_named | — |
| delivery-plan | █ · · · · | L0_named | — |
| sim-esim-lifecycle | █ · · · · | L0_named | — |
...
| S-0004 | mobile-core-architect | active | depends on a committed priority and pre-emption profile in the core |
...
|---|---|---|---|---|---|
| S-0005 | Amina Duarte | media-distribution | multicast on the radio side | C-0002 | detected |
| S-0006 | Rui Vasconcelos | media-distribution | unicast only, multicast deferred | C-0002 | detected |
...
| S-0004 | active | depends on a committed priority and pre-emption profile in the core |
...
Status **PROVISIONAL**, with **1** conflict(s) open and
**16** subjects below `L3_decided`. The reason matters: the
