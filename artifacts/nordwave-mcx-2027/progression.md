...
|---|---|---|
| L1_framed | Comment se décompose l'architecture de mobile-core (Section 4.1) ?
Pat | The MCX layer delivers group voice, data and video to dispatchers and  |
| L2_decomposed | Décomposition de mcx-services | Decomposition of mcx-services |
